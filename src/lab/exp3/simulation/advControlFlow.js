...
window.view = {
    ...
    startBtn: function() {
		...
		else if (selected_loop === 'while' && inputValue !== '' && !isNaN(model.inp)&& this.valid(inputValue))
		{
			this.displayLoop('whileLoopContent', 'codeContentWhile1')
		}
		else if (selected_loop === 'do-while' && inputValue !== '' && !isNaN(model.inp)&& this.valid(inputValue))
		{
